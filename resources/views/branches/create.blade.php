...
@section('custom_title', 'Add Branch')

@section('main')
    <div class="main add-emp">

        <div class="container">
            <form action="{{ route('branches.store') }}" method="POST" enctype="multipart/form-data" class="container">
                @csrf
                ...
                <div style="display: flex; justify-content: space-between; width: 100%; gap: 20px;">
                    <div class="input-group">
                        ...
                        <input type="text" name="branch_name" id="branch_name" value="{{ old('name') }}" required>
                        @error('branch_name')
                ...
                <div style="display: flex; justify-content: space-between; width: 100%; gap: 20px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="services_gmail" id="services_gmail" value="{{ old('services_gmail') }}">
