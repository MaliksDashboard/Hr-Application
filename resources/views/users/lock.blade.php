...
<body>
    <div class="left-container">
        ...
        <div style="margin-bottom: 20px;" class="instruction">
            <h2>Welcome Back {{ explode(' ', Auth::user()->name)[0] }}!
            </h2>

            <p style="font-size: 14px;">Enter your password to access the admin.
            </p>
        ...
        <div style="display: flex;align-items: center;gap: 10px;margin-top: 20px; justify-content: center;">
            <p style="color: #ff6c2f">Not You?</p>
