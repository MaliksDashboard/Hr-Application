...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/load-more-promotions', [PromotionController::class, 'loadMorePromotions']);
    ...
    Route::post('/badge/generate', [BadgeController::class, 'generateBadge'])->name('badge.generate');
    Route::get('/getEmployeesByBranch/{branchId}', [BadgeController::class, 'getEmployeesByBranch']);
